...
import org.d3if0069.miniprojek2.navigation.Screen
import org.d3if0069.miniprojek2.util.SettingsDataStore
...
fun ScreenContent(showList: Boolean, modifier: Modifier, navController: NavHostController){
    ...
    val db = TaekwondoDb.getInstance(context)
...
@Composable
fun ListItem(taekwondo: Taekwondo, onClick: () -> Unit) {
    Column (
        modifier = Modifier
            .fillMaxSize()
            .clickable { onClick() }
...
@Composable
fun GridItem(taekwondo: Taekwondo, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
